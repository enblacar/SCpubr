...
SCpubr::do_FeaturePlot(sample, idents.highlight = levels(sample)[!(levels(sample) %in% c("2", "5", "8"))], features = c("CD14"), plot.title = "My very important features", ncol = 2)
```
...
SCpubr::do_BeeSwarmPlot(sample, feature_to_rank = "nCount_RNA", group.by = "seurat_clusters", continuous_feature = TRUE)
```
