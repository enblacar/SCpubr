...
do_ColorPalette <- function(colors.use,
  ...
  if (isTRUE(complete_output)){
    # List of colors.
    return_colors <- list("wheel" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                            n = n),
                          "opposite" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                               n = n,
                                                               opposite = TRUE),
                          "adjacent" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                               n = n,
                                                               adjacent = TRUE),
                          "triadic" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                              n = n,
                                                              triadic = TRUE),
                          "split_complementary" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                                          n = n,
                                                                          split_complementary = TRUE),
                          "tetradic" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                               n = n,
                                                               tetradic = TRUE),
                          "square" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                             n = n,
                                                             square = TRUE))

    # List of plots.
    return_plots <- list("wheel" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                           n = n,
                                                           plot = TRUE),
                         "opposite" = SCpubr::do_ColorPalette(colors.use = colors.use,
                                                              n = n,
