...
#'
#' @param sample An object of class Seurat, generated by \link[Seurat]{CreateSeuratObject}.
#' @param font.size \link[base]{numeric}. Overall font.size of the plot.
#' @param font.type \link[base]{character}. Base font for the plot. One of mono, serif or sans.
#' @param legend.type \link[base]{character}. Type of legend to display. One of: normal, colorbar, colorsteps.
#' @param legend.position \link[base]{character}. Position of the legend in the plot. One of: top, bottom, left, right or none (if no legend is desired).
#' @param legend.framewidth,legend.tickwidth \link[base]{numeric}. Width of the lines of the box in the legend.
#' @param legend.framecolor,legend.tickcolor \link[base]{character}. Color of the lines of the box in the legend.
#' @param legend.length,legend.width \link[base]{numeric}. Length and width of the legend. Will adjust automatically depending on legend side.
#' @param plot.title,plot.subtitle,plot.caption \link[base]{character}. Title, subtitle or caption to use in the plot.
#' @param reduction \link[base]{character}. Reduction to use. Can be the canonical ones such as "umap", "pca", or any custom ones, such as "diffusion". If you are unsure about which reductions you have, use `Seurat::Reductions(sample)`. Defaults to "umap" if present or to the last computed reduction if the argument is not provided.
#' @param assay \link[base]{character}. Assay to use. Defaults to the current assay.
#' @param slot \link[base]{character}. Data slot to use. \link[base]{character}. Only one of: counts, data, scale.data. Defaults to "data".
#' @param viridis_color_map \link[base]{character}. A capital letter from A to H or the scale name as in \link[viridis]{scale_fill_viridis}.
#' @param raster \link[base]{logical}. Whether to raster the resulting plot. This is recommendable if plotting a lot of cells.
#' @param raster.dpi \link[base]{numeric}. Pixel resolution for rasterized plots. Defaults to 512, as per default `Seurat::FeaturePlot()` behavior.
#' @param plot_cell_borders \link[base]{logical}. Whether to plot border around cells.
#' @param border.size \link[base]{numeric}. Width of the border of the cells.
#' @param border.color \link[base]{character}. Color to use for the border of the cells.
#' @param na.value \link[base]{character}. Color value for NA.
#' @param rotate_x_axis_labels \link[base]{logical}. Whether to rotate X axis labels.
#' @param xlab,ylab \link[base]{character}. Titles for the X and Y axis.
#'
#'
#'
#'
